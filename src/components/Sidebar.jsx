          ...
          <MenuList minWidth="240px" p="20px" bg="brand.50">
            <CheckboxGroup defaultValue={[...category]}>
              <Stack spacing={[1, 2]} direction="column">
                <Checkbox value="Dry Fruit" onChange={onCategory}>
                  Dry Fruit
                </Checkbox>
                <Checkbox value="Nuts" onChange={onCategory}>
                  Nuts
                </Checkbox>
                <Checkbox value="Seeds" onChange={onCategory}>
                  Seeds
                </Checkbox>
                <Checkbox value="Spices" onChange={onCategory}>
                  Spices
                </Checkbox>
                <Checkbox value="Dates" onChange={onCategory}>
                  Dates
                </Checkbox>
                <Checkbox value="Gourmet Products" onChange={onCategory}>
                  Gourmet Products
                </Checkbox>
              </Stack>
            </CheckboxGroup>
